...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
    ...
    public static Image subImage(Image source, int x, int y, int w, int h) {
        ...
        if(source == null) {
            // Print Error message
            System.out.println("Error 526: cannot extract a subImage from a null image.\n");
            // Return null
            return null;
        }
    ...
    public void drawImage(Image image, double x, double y) {
        ...
        if(image == null) {
            // Print Error message
            System.out.println("Error 546: cannot draw null image.\n");
            return;
        }
    ...
    public void drawImage(Image image, double x, double y, double w, double h) {
        ...
        if(image == null) {
            // Print Error message
            System.out.println("Error 559: cannot draw null image.\n");
            return;
        }
    ...
    public AudioClip loadAudio(String filename) {
        try {
            ...
            // Catch Exception
            System.out.println("Error 703: cannot open Audio File " + filename + "\n");
        }
